    ...
    for (const section of document.sections) {
        for (const block of section.blocks) {
            ...
            entries.push(Object.freeze({
                ...
                annotationSignature: JSON.stringify([block.annotations?.[languageKey] || [],block.titleRegion || null,block.indentByLanguage?.[languageKey] || null,block.textAlignByLanguage?.[languageKey] || null]),
