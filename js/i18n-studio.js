...
export const STRINGS = {
    ja: {
        ...
        publication_listed_until: '掲載期限',
        publication_public_until: '公開期限',
        publication_no_limit:  '無期限',
        publication_press_hint:'発行時点で期限メタデータとして保存されます。',
    ...
    en: {
        ...
        publication_listed_until: 'Listing until',
        publication_public_until: 'Public until',
        publication_no_limit:  'No limit',
        publication_press_hint:'Stored as publication metadata when you publish.',
